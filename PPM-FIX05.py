...
Nama_BM = st.selectbox('Silahkan Pilih BM (mg/mmol)', ['BM CaCO3 100 mg/mmol','BM Ca 40 mg/mmol'])
Nilai_BM = st.selectbox('Silahkan Pilih Nilai BM (mg/mmol)', ['Pilih Nilai BM',100,40])
FP = st.selectbox('Silahkan Pilih Nilai FP', ['Pilih Nilai FP',1,100/50,100/25,250/50,100/10])
